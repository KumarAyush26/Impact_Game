...
MyGame = ig.Game.extend({
    ...
    draw: function() {
        ...
        if( this.font ) {
            ...
            var y = 10;
            this.font.draw('Controls:', x, y, ig.Font.ALIGN.RIGHT);
            this.font.draw('Left/Right: Move', x, y + 10, ig.Font.ALIGN.RIGHT);
            this.font.draw('X: Jump', x, y + 20, ig.Font.ALIGN.RIGHT);
            this.font.draw('C: Shoot', x, y + 30, ig.Font.ALIGN.RIGHT);
            this.font.draw('Tab: Switch Weapon', x, y + 40, ig.Font.ALIGN.RIGHT);
        }
    }
});
