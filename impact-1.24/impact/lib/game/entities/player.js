...
EntityPlayer = ig.Entity.extend({
    ...
    init: function(x, y, settings) {
        ...
        // animation setup uses weapon offset
    ...
    setupAnimation: function(offset) {
        offset = offset * 10; // player frames per weapon set
    ...
    update: function() {
        ...
        // set animation depending on velocity
        if( this.vel.y < 0 ) {
    ...
    draw: function() {
        ...
        ctx.fillText('Player', x, y - 12 * ig.system.scale);
    }
});
...
EntityBullet = ig.Entity.extend({
    ...
    init: function(x, y, settings) {
        // offset spawn so bullet appears from gun
...
EntityDeathExplosionParticle = ig.Entity.extend({
    ...
    init: function(x, y, settings) {
        ...
        this.vel.x = (Math.random() * 2 - 1) * this.maxVel.x;
        this.vel.y = -Math.random() * this.maxVel.y;
    }
});
